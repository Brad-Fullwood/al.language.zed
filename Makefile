...
.PHONY: build install install-lsp dev-setup watch rust wasm bridges grammar language record-methods check-record-methods repro-artifacts microsoft-contracts live-bc-contracts release-dryrun crates-publish-dryrun plugin-validate clean
