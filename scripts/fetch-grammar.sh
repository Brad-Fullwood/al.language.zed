...
# repository is unreachable (sandboxed agent sessions are scoped to this repo
# only — F4 in SYSTEM_REVIEW_ACTION_PLAN.md). The branch is maintained by
...
# This script is the fallback, not the primary path.
set -euo pipefail
cd "$(dirname "$0")/.."
