...
pub(crate) async fn handle_completion(
    ...
    let entries =
        al_core::queries::completions::completions_full(&server.workspace, uri, core_pos).await;
    if entries.is_empty() {
        return None;
    }
    let items: Vec<CompletionItem> = entries
        ...
        .map(|e| {
            let kind = match e.kind {
                al_core::queries::completions::CompletionKind::Keyword => {
                    CompletionItemKind::KEYWORD
                }
                al_core::queries::completions::CompletionKind::Snippet => {
                    CompletionItemKind::SNIPPET
                }
                al_core::queries::completions::CompletionKind::Field => CompletionItemKind::FIELD,
                al_core::queries::completions::CompletionKind::Property => {
                    CompletionItemKind::PROPERTY
                }
                al_core::queries::completions::CompletionKind::Method => CompletionItemKind::METHOD,
                al_core::queries::completions::CompletionKind::Function => {
                    CompletionItemKind::FUNCTION
                }
                al_core::queries::completions::CompletionKind::Variable => {
                ...
                al_core::queries::completions::CompletionKind::EnumMember => {
                ...
                al_core::queries::completions::CompletionKind::Reference => {
