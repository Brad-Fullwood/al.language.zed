...
/// [`references::build_reference_counts`], reused while the workspace generation and the
...
fn reference_counts(
    ...
    let counts = Arc::new(references::build_reference_counts(workspace, current_uri)?);
