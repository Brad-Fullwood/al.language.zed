...
| B14 | 🟠 | Profiler accuracy | Self-time ≈ hit-count (1 ms/sample) rather than `timeDeltas` aggregation | `profiling.rs`; `queries/profiler_hints.rs` | Aggregate `timeDeltas` for accurate timing. |
